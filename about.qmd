---
title: "About EPICC-Lab"
---

## What we do

EPICC-Lab (Evolution · Policy · Inference · Causality · Culture) uses causal inference to address long-standing debates and real-world problems. Rigorous causal analysis clarifies what works, for whom, and when — questions that matter for both science and policy.
...
leaflet() %>%
  ...
  addMarkers(lng=174.7681, lat=-41.2889, 
             popup="EPICC-Lab<br>Easterfield Building EA 324<br>Victoria University of Wellington")
```
