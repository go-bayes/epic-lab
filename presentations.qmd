...
::: {.callout-note}
## Download Workshop Scripts Package
...
<a href="https://www.dropbox.com/scl/fi/a0jxyossvmijwne75hdvq/sparcc-workshop-scripts.zip?rlkey=clzv8p30yxezngyu5r7e313qk&dl=0" class="btn btn-primary" target="_blank" style="display: inline-block; padding: 0.75rem 1.5rem; background: #28a745; color: white; text-decoration: none; border-radius: 4px; margin: 0.5rem;">
    📦 Download Workshop Scripts (.zip)
</a>
</div>
