...
<div style="text-align: center; padding: 2rem; background: #f8f9fa; border: 1px solid #ddd; border-radius: 4px;">
    ...
    <iframe src="https://www.dropbox.com/scl/fi/bmbr9do4pn5facnl0idc2/presentation.pdf?rlkey=10i5z7d0fghwfa8b7vdyb6e75&dl=0&raw=1" 
            width="100%" height="500px" style="border: 1px solid #ddd; border-radius: 4px; margin: 1rem 0;">
    </iframe>
    <br>
    <a href="https://www.dropbox.com/scl/fi/bmbr9do4pn5facnl0idc2/presentation.pdf?rlkey=10i5z7d0fghwfa8b7vdyb6e75&dl=0" class="btn btn-primary" target="_blank" style="display: inline-block; padding: 0.75rem 1.5rem; background: #0066cc; color: white; text-decoration: none; border-radius: 4px; margin-top: 1rem;">
        Open in New Tab
    </a>
</div>
```
...
<div style="text-align: center; padding: 2rem; background: #f8f9fa; border: 1px solid #ddd; border-radius: 4px;">
    <h3>📖 View Presentation</h3>
    <p>This PDF presentation is hosted on Dropbox for optimal performance.</p>
    <iframe src="https://www.dropbox.com/scl/fi/PLACEHOLDER-HTE/presentation.pdf?rlkey=PLACEHOLDER-HTE-KEY&dl=0&raw=1" 
            width="100%" height="500px" style="border: 1px solid #ddd; border-radius: 4px; margin: 1rem 0;">
    </iframe>
    <br>
    <a href="https://www.dropbox.com/scl/fi/PLACEHOLDER-HTE/presentation.pdf?rlkey=PLACEHOLDER-HTE-KEY&dl=0" class="btn btn-primary" target="_blank" style="display: inline-block; padding: 0.75rem 1.5rem; background: #0066cc; color: white; text-decoration: none; border-radius: 4px; margin-top: 1rem;">
        Open in New Tab
    </a>
</div>
```
