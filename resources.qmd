...
A framework for causal inference with panel data, supporting doubly robust estimation and sensitivity analyses.
...
**ggdag**  
Create directed acyclic graphs (DAGs) for causal inference.
...
*Tyler VanderWeele*  
[Link to OUP page](https://global.oup.com/academic/product/explanation-in-causal-inference-9780199325870) * I think this best book ever written on causal mediation analysis and interaction -- and arguably one of the best books every written in statistics! Expensive, unfortunately, but worth checking out of the library (or purchasing if you have the means).
:::
...
[Free Online](https://theeffectbook.net/) • Practical guide with good visualisations. Accessible.
:::
::::
